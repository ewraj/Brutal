...
def load_system_prompt() -> str:
    """Loads the system prompt from the persona file."""
    # Assumes the persona file is in the same directory as the script.
...
def get_response(messages: list, model: str) -> str:
    # Temperature is set low (0.2) for more deterministic, factual responses,
    # aligning with the "brutally optimal" persona.
...
def reset_messages() -> list:
    """Returns a new message list with the system prompt."""
